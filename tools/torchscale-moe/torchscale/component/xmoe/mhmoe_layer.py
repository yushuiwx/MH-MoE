...
class MOELayer(Base):
    ...
    def forward(self, *input: Tensor, input_padding_mask=None, **kwargs: Any) -> Tensor:
        ...
        ######################################## multi-heads ##########################################
        # # # print(reshaped_input.shape, reshaped_input_padding_mask.shape) # [bs * 2048, dim], #[bs * 2048]
        # # print("previous reshaped_input", reshaped_input.shape, "self.mhmoe_heads_number", self.mhmoe_heads_number)
