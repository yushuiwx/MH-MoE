...
@dataclass
class HalfCosineLRScheduleConfig(FairseqDataclass):
...
@register_lr_scheduler("half_cosine", dataclass=HalfCosineLRScheduleConfig)
class HalfCosineLRSchedule(FairseqLRScheduler):
    ...
    def __init__(self, cfg: HalfCosineLRScheduleConfig, fairseq_optimizer):
    ...
    def step_update(self, num_updates):
        ...
        if num_updates < self.cfg.warmup_updates:
            ...
            self.lr = min_lr + (max_lr - min_lr) * math.cos(0.5 * math.pi * t_curr / t_i)
