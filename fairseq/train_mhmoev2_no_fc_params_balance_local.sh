...
OUTPUT_PATH=$OUTPUT_FOLDER/mhmoe_v2_no_fc_params_balance_2_has_fc/small-baseline-redstone_v2-flash_attn-${expert}experts-${heads_number}heads
...
--moe-gate-loss-wt 0.01 --moe-gate-loss-combine-method sum  --use-xmoe --use-mhmoe --mhmoe-heads-number ${heads_number}