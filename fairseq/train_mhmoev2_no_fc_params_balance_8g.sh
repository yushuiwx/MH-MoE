...
PORT=29001
heads_number=$2
OUTPUT_FOLDER='/mnt1/msranlpintern/wuxun/MoE/MoE_results/16GPUs'
OUTPUT_PATH=$OUTPUT_FOLDER/no_vanilla_transformer_mhmoe_same_heads/mhmoe_v2_no_fc_params_balance_2/small-baseline-redstone_v2-flash_attn-${expert}experts-${heads_number}heads
...
python -m torch.distributed.launch --nproc_per_node=8 --master_port $PORT train.py /mnt/msranlp/shaohanh/data/redstone_v2_1_config/  \
